...
function Jobs () {
    return (
        ...
        subtitle="Fev 2022 - Atualmente"> Utilizamos como linguagem principal o PHP e um framework próprio da empresa. 
        ...
        pelos clientes assim como realizamos a manutenção do software corrigindo eventuais bugs e melhorando a performance do produto. </Content>
        </div>
    )
}
